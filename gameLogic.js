...
const WORD_CATEGORIES = {
  food: {
    label: '일상',
    words: [
      '뱀', '엔지니어', '신해량', '칫솔', '치약', '바다의', '노을이', '손전등', '가팀', '씬해량', '체육관', '전시장', '무설탕사탕',
      '치과', '유금이', '서지혁', '치실', '해저기지', '고양이', '바다', '가족', '뜨개질', '커피', '담배', '진료', '연구원', '태평양',
      '스케일링', '케이블카', '헨리', '박무진', '침대', '나는', '떨어지는', '충격에', '잠에서', '깼다', '어금니', '스쿠버', '다이빙', '수영'
    ],
  },
  fruit: {
    label: '시작',
    words: [
      ...
      '초콜릿', '사탕', '유금이', '의식', '서지혁', '가족', '백호동', '김가영', '백애영', '강수정', '어두운', '벤자민', '방수', '신호', '상어',
      '무장', '엘리베이터', '포커', '잠수정', '한국', '일본', '캐나다', '중국', '미국', '되어', '케이블카', '딥블루', '자판기', '관절', '캐새끼', 
	  '용병', '돌격', '소총', '동물', '아이'
    ],
  },
  color: {
    label: '탈출',
    words: [
      '암흑', '스미레', '배낭', '김재희', '뱀', '엠마', '복면', '금괴', '어두운', '총구', '주작동', '인간혐오', '이지현', '진통제', '고양이', '냉병기', '해수면',
      '침수', '붕대', '바다의', '대한도', '양말', '박무현', '형', '코피', '가족', '낙하산', '첼로니', '서지혁', '백애영', '그린란드', '문신', '연산호',
  ...
  animal: {
    label: '시도',
    words: [
      '생존의지', '총소리', '해저기지', '어두운', '도와', '다이아몬드', '구원자', '엘리자베스', '보석', '동생', '팀장', '칼', '불면증',
      '부팀장', '되어', '메딕', '패드', '정상현', '영화관', '의족', '반복', '희생', '시도', '헤드샷', '바다의', '신해량', '귀금속', '머리',
      '무한교', '구명조끼', '의수', '과거', '겨우살이', '등불이', '라피도포라', '총', '구원자', '걸어', '오렌지', '검은', '사살', '제단'
    ],
  },
  space: {
    label: '심화',
    words: [
      ...
      '바다의', '배신자', '소원', '구원자', '반복', '잠수정', '실패', '침수', '총상', '구원', '의지', '손가락',
