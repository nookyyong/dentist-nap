...
const WORD_CATEGORIES = {
  ...
  color: {
    ...
    words: [
      ...
      '침수', '붕대', '바다의', '대한도', '양말', '박무현', '신해량', '형', '코피', '가족', '낙하산', '첼로니', '서지혁', '백애영', '유금이',
  ...
  animal: {
    ...
    words: [
      ...
      '무한교', '구명조끼', '인간혐오', '의수', '과거', '사이비', '박무현', '코피', '등불이', '라피도포라', '총', '구원자', '딥블루', '걸어'
    ],
  },
  space: {
    label: '심화',
    words: [
      '비이성적', '지상', '대한도', '김재희', '보석', '원석', '무한교', '사이비', '다이아몬드', '가족', '섬망',
...
const LEVEL_WORD_WEIGHTS = [
  ...
  /* lv 7 */ { food: 1,  fruit: 1,  color: 1,  animal: 3,  space: 3,  cat: 1 },
];
