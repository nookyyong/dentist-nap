...
const WORD_CATEGORIES = {
  food: {
    ...
    words: [
      ...
      '스케일링', '케이블카', '헨리', '딥블루', '박무진', '침대', '나는', '떨어지는', '충격에', '잠에서', '깼다'
    ],
  },
  fruit: {
    label: '시작',
    words: [
      '탈출정', '계단', '박무현', '무한교', '블라디미르', '등불이', '바다의', '사이비', '해파리', '빵', '침수', '물', '불', '양말',
      '초콜릿', '사탕', '유금이', '신해량', '의식', '서지혁', '가족', '백호동', '김가영', '백애영', '강수정', '어두운', '벤자민', '낚시줄',
      '무장', '엘리베이터', '포커', '잠수정', '되어', '백상아리', '딥블루', '자판기', '관절', '캐시키', '용병', '돌격', '소총', '동물', '아이'
    ],
  },
  color: {
    label: '탈출',
    words: [
      '암흑', '스미레', '가방', '김재희', '뱀', '복면', '금괴', '어두운', '총구', '주작동', '인간혐오', '이지현', '강수정', '진통제', '고양이',
      '침수', '붕대', '바다의', '대한도', '양말', '박무현', '신해량', '형', '코피', '가족', '낙하산줄', '첼로니', '서지혁', '백애영', '유금이',
      '구원자', '목걸이', '등불이', '라피스라줄리', '총성', '의족', '팀원', '해저기지', '딥블루', '병원', '금괴', '물', '무릎', '구원', '보석'
    ],
  },
  animal: {
    label: '시도',
    words: [
      '생존의지', '총소리', '해저기지', '어두운', '금괴', '다이아몬드', '구원자', '엘리자베스', '보석', '동생', '팀장', '칼',
      '부팀장', '되어', '메딕', '패드', '정상현', '영화관', '의족', '반복', '희생', '시도', '백상아리', '바다의', '신해량', '귀금속', '가족', '머리',
      '무한교', '구명조끼', '인간혐오', '의수', '과거', '사이비', '박무현', '코피', '등불이', '라피도포라', '총', '구원자', '딥블루'
    ],
  },
  space: {
    label: '심화',
    words: [
      '비이성적', '지상', '대한도', '김재희', '보석', '원석', '무한교', '사이비', '다이아몬드', '가족',
      '바다의', '배신자', '소원', '구원자', '딥블루', '반복', '잠수정', '실패', '침수', '총상', '구원', '의지',
      '어두운', '메딕', '딥블루', '의수', '코피', '화분', '총', '나는', '이제', '바다를', '안다'
    ],
  },
  cat: {
    label: '끝',
...
const LEVEL_WORD_WEIGHTS = [
  ...
  /* lv 6 */ { food: 1,  fruit: 1,  color: 2,  animal: 2,  space: 3,  cat: 1 },
  /* lv 7 */ { food: 1,  fruit: 1,  color: 1,  animal: 2,  space: 3,  cat: 2 },
];
